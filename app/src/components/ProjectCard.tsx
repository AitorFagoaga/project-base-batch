...
export function ProjectCard({ project, creatorReputation, isLoadingReputation }: ProjectCardProps) {
  ...
  return (
    <div className="group rounded-3xl border border-gray-100 bg-white/80 p-4 shadow-[0_18px_40px_-24px_rgba(79,70,229,0.4)] transition-shadow hover:shadow-[0_28px_60px_-30px_rgba(79,70,229,0.55)]">
      <div className="relative aspect-[4/3] overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100">
        <Image
          src={projectImage}
      ...
      <div className="mt-5 space-y-4">
        <div className="space-y-2">
          <h3 className="text-lg font-semibold text-gray-900 line-clamp-1">{safeProject.title}</h3>
        ...
        <div className="flex items-center justify-between">
          <Link
            ...
            className="rounded-full bg-gray-900 px-5 py-2 text-sm font-semibold text-white transition hover:bg-indigo-600"
          >
            Ver Proyecto
          </Link>
          <button
